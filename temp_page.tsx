      ...
      {tab==="social"&&(
        <div className="space-y-5">
          ...
          <div className="p-5 rounded-2xl" style={{background:"rgba(255,255,255,0.8)",border:"1px solid rgba(0,0,0,0.06)"}}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div><label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase">📘 Facebook</label><input value={form.facebookUrl||""} onChange={e=>setForm({...form,facebookUrl:e.target.value})} className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20" style={{background:"#f8fafc",border:"1.5px solid #e2e8f0"}} placeholder="https://facebook.com/..."/></div>
              <div><label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase">𝕏 Twitter / X</label><input value={form.twitterUrl||""} onChange={e=>setForm({...form,twitterUrl:e.target.value})} className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20" style={{background:"#f8fafc",border:"1.5px solid #e2e8f0"}} placeholder="https://x.com/..."/></div>
              <div><label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase">📸 Instagram</label><input value={form.instagramUrl||""} onChange={e=>setForm({...form,instagramUrl:e.target.value})} className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20" style={{background:"#f8fafc",border:"1.5px solid #e2e8f0"}} placeholder="https://instagram.com/..."/></div>
              <div><label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase">▶️ YouTube</label><input value={form.youtubeUrl||""} onChange={e=>setForm({...form,youtubeUrl:e.target.value})} className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20" style={{background:"#f8fafc",border:"1.5px solid #e2e8f0"}} placeholder="https://youtube.com/..."/></div>
              <div><label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase">✈️ Telegram</label><input value={form.telegramUrl||""} onChange={e=>setForm({...form,telegramUrl:e.target.value})} className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20" style={{background:"#f8fafc",border:"1.5px solid #e2e8f0"}} placeholder="https://t.me/..."/></div>
              <div className="sm:col-span-2"><label className="block text-[10px] font-bold text-slate-500 mb-1 uppercase">💬 WhatsApp Grup/Kanal (Tek Link)</label><input value={form.whatsappGroupUrl||""} onChange={e=>setForm({...form,whatsappGroupUrl:e.target.value})} className="w-full px-4 py-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500/20" style={{background:"#f8fafc",border:"1.5px solid #e2e8f0"}} placeholder="https://chat.whatsapp.com/..."/></div>
