...
import {
    ...
    ArrowRight, Sparkles, FileSignature
} from 'lucide-react'
        ...
        <>
            <section className="relative pt-32 pb-20 px-4 overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto text-center">
                        ...
                        {!loading && (
                            user ? (
                                ...
                                <Button
                                    ...
                                    className="h-14 px-8 text-lg bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 shadow-lg shadow-emerald-500/30 cursor-pointer"
                                >
                    ...
                    {/* Stats Bar */}
                    <div id="stats" className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto scroll-mt-32">
                        {stats.map((stat) => (
