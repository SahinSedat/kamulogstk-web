...
export const metadata: Metadata = {
  title: "Gizlilik Politikası — Kamulog",
  description:
    "Kamulog uygulamasının gizlilik politikası. Kişisel verilerinizin nasıl toplandığı, kullanıldığı ve korunduğu hakkında bilgi edinin.",
};
